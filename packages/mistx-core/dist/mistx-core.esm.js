...
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[Exchange.UNI] = '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D', _ROUTER_ADDRESS[Exchange.SUSHI] = '0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9', _ROUTER_ADDRESS[Exchange.UNDEFINED] = '0x0', _ROUTER_ADDRESS);
...
var computePairAddress = function computePairAddress(_ref) {
  ...
  return getCreate2Address(FACTORY_ADDRESS[exchange], keccak256(['bytes'], [pack(['address', 'address'], [token0.address, token1.address])]), INIT_CODE_HASH[exchange]);
};
/**
...
var Ether = /*#__PURE__*/function (_NativeCurrency) {
  ...
  _createClass(Ether, [{
    ...
    get: function get() {
      ...
      !!!weth ? process.env.NODE_ENV !== "production" ? invariant(false, 'WRAPPED') : invariant(false) : void 0;
      return weth;
    }
  }]);
...
var Trade = /*#__PURE__*/function () {
  ...
  * @param minerBribeMargin the margin to beat the gas price by
  ...
  currentPairs, nextAmountIn, bestTrades) {
    ...
    !(nextAmountIn === currencyAmountIn || currentPairs.length > 0) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INVALID_RECURSION') : invariant(false) : void 0;
    var tradeType = TradeType.EXACT_INPUT;
  ...
  currentPairs, nextAmountOut, bestTrades) {
    ...
    !(pairs.length > 0) ? process.env.NODE_ENV !== "production" ? invariant(false, 'PAIRS') : invariant(false) : void 0;
    !(maxHops > 0) ? process.env.NODE_ENV !== "production" ? invariant(false, 'MAX_HOPS') : invariant(false) : void 0;
    !(nextAmountOut === currencyAmountOut || currentPairs.length > 0) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INVALID_RECURSION') : invariant(false) : void 0;
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountIn.currency.equals(tokenIn)) {
        try {
          var newTrade = new Trade(new Route([pair].concat(currentPairs), currencyIn, currencyAmountOut.currency), currencyAmountOut, TradeType.EXACT_OUTPUT, gasPriceToBeat, minerBribeMargin);
          sortedInsert(bestTrades, newTrade, maxNumResults, tradeComparator);
        } catch (e) {// catch the invariant
          // console.log('trade constructor err', e)
        }
  ...
  Trade.estimateMinTradeAmounts = function estimateMinTradeAmounts(pairs, currencyIn, currencyOut, gasPriceToBeat, minerBribeMargin, minTradeMargin, _temp3) {
    ...
    var exactInGas = estimatedGasForMethod(Trade.methodNameForTradeType(TradeType.EXACT_INPUT, etherIn, etherOut), maxHops.toString());
  ...
  Trade.estimateBribeAmounts = function estimateBribeAmounts(gasPriceToBeat, minerBribeMargin) {
    ...
    var bribesByMethod = (_bribesByMethod = {}, _bribesByMethod[MethodName.swapETHForExactTokens] = CurrencyAmount.fromRawAmount(ETH, calculateMinerBribe(gasPriceToBeat, estimatedGasForMethod('swapETHForExactTokens'), minerBribeMargin)), _bribesByMethod[MethodName.swapExactETHForTokens] = CurrencyAmount.fromRawAmount(ETH, calculateMinerBribe(gasPriceToBeat, estimatedGasForMethod('swapExactETHForTokens'), minerBribeMargin)), _bribesByMethod[MethodName.swapExactTokensForETH] = CurrencyAmount.fromRawAmount(ETH, calculateMinerBribe(gasPriceToBeat, estimatedGasForMethod('swapExactTokensForETH'), minerBribeMargin)), _bribesByMethod[MethodName.swapExactTokensForTokens] = CurrencyAmount.fromRawAmount(ETH, calculateMinerBribe(gasPriceToBeat, estimatedGasForMethod('swapExactTokensForTokens'), minerBribeMargin)), _bribesByMethod[MethodName.swapTokensForExactETH] = CurrencyAmount.fromRawAmount(ETH, calculateMinerBribe(gasPriceToBeat, estimatedGasForMethod('swapTokensForExactETH'), minerBribeMargin)), _bribesByMethod[MethodName.swapTokensForExactTokens] = CurrencyAmount.fromRawAmount(ETH, calculateMinerBribe(gasPriceToBeat, estimatedGasForMethod('swapTokensForExactTokens'), minerBribeMargin)), _bribesByMethod);
...
//# sourceMappingURL=mistx-core.esm.js.map
