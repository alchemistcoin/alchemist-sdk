...
var MistxSocket = /*#__PURE__*/function () {
  ...
  _proto.disconnect = function disconnect() {
    ...
    this.socket.off(exports.Event.FEES_CHANGE);
  ...
  _proto.init = function init(_ref) {
    ...
    this.socket.on(exports.Event.FEES_CHANGE, function (response) {
      if (onFeesChange) {
        var fees = {
          block: response.block,
          baseFeePerGas: bignumber.BigNumber.from(response.baseFeePerGas),
          "default": {
            maxFeePerGas: bignumber.BigNumber.from(response["default"].maxFeePerGas),
            maxPriorityFeePerGas: bignumber.BigNumber.from(response["default"].maxPriorityFeePerGas)
          },
          low: {
            maxFeePerGas: bignumber.BigNumber.from(response.low.maxFeePerGas),
            maxPriorityFeePerGas: bignumber.BigNumber.from(response.low.maxPriorityFeePerGas)
          },
          med: {
            maxFeePerGas: bignumber.BigNumber.from(response.med.maxFeePerGas),
            maxPriorityFeePerGas: bignumber.BigNumber.from(response.med.maxPriorityFeePerGas)
          },
          high: {
            maxFeePerGas: bignumber.BigNumber.from(response.high.maxFeePerGas),
            maxPriorityFeePerGas: bignumber.BigNumber.from(response.high.maxPriorityFeePerGas)
          }
        };
        onFeesChange(fees);
      }
  ...
  _proto.emitBundleRequest = function emitBundleRequest(bundle) {
    this.socket.emit(exports.Event.BUNDLE_REQUEST, bundle);
  };
