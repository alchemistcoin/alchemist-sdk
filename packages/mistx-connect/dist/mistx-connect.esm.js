...
var MistxSocket = /*#__PURE__*/function () {
  ...
  _proto.init = function init(_ref) {
    ...
    this.socket.on(Event.BUNDLE_STATUS_RESPONSE, function (response) {
...
export { Diagnosis, Event, MistxSocket, STATUS_LOCALES, Status };
//# sourceMappingURL=mistx-connect.esm.js.map
