...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@alchemist-coin/mistx-core'
...
export abstract class SwapRouter {
  public static INTERFACE: Interface = new Interface(SwapRouterAbi.abi)
